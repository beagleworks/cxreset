...
- Clarify that cxreset is an unofficial project and document compatibility expectations around the experimental Codex CLI app-server
- Move npm/GitHub Actions release instructions out of the README into dedicated releasing guides
